...
export default function OnboardingFormV3() {
  ...
  const hasCredentialingSelected =
    (formData.requestedServices ?? []).includes("CREDENTIALING");
  const hasBillingRcmSelected =
    (formData.requestedServices ?? []).includes("BILLING_RCM");
  const hasMarketingSelected =
    (formData.requestedServices ?? []).some((service) =>
      marketingServiceValues.includes(service),
    );
  const hasLabPharmacySelected =
    (formData.requestedServices ?? []).some((service) =>
              ...
              <div className="grid gap-6">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                  <Field label="Website URL">
                    <TextInput
                      ...
                      onChange={(event) =>
                        updateNestedField("marketing", "websiteUrl", event.target.value)
                      }
                    />
                  </Field>
                  ...
                  <Field label="Monthly Marketing Budget">
                    <SelectInput
                      ...
                      onChange={(event) =>
                        updateNestedField("marketing", "monthlyMarketingBudget", event.target.value)
                      }
                      options={[
                  ...
                  <Field label="Google Business Profile Claimed?">
                    <BooleanRadioGroup
                      ...
                      value={formData.marketing?.googleBusinessProfileClaimed ?? false}
                      onChange={(value) =>
                        updateNestedField("marketing", "googleBusinessProfileClaimed", value)
                      }
                    />
                  </Field>
                </div>
                ...
                <Field label="Active Social Media Channels">
                  <CheckboxGroup
                    ...
                    onToggle={(value) =>
                      toggleNestedArrayValue("marketing", "socialMediaChannels", value)
                    }
                  />
                </Field>
                ...
                <Field label="Current Marketing Channels">
                  <CheckboxGroup
                    options={[
                      ...
                      { label: "Social Media Ads", value: "SOCIAL_MEDIA_ADS" },
                      { label: "SEO", value: "SEO" },
                    ...
                    values={formData.marketing?.currentMarketingChannels ?? []}
                    onToggle={(value) =>
                      toggleNestedArrayValue("marketing", "currentMarketingChannels", value)
                    }
                  />
                </Field>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <Field label="Target Patient Demographics">
                    <TextArea
                      rows={3}
                      value={formData.marketing?.targetPatientDemographics ?? ""}
                      onChange={(event) =>
                        updateNestedField("marketing", "targetPatientDemographics", event.target.value)
                      }
                  ...
                  <Field label="Patient Acquisition Goals">
                    <TextArea
                      rows={3}
                      value={formData.marketing?.patientAcquisitionGoals ?? ""}
                      onChange={(event) =>
                        updateNestedField("marketing", "patientAcquisitionGoals", event.target.value)
                      }
                ...
                <Field label="Existing Brand Assets">
                  <TextArea
                    ...
                    onChange={(event) =>
                      updateNestedField("marketing", "existingBrandAssets", event.target.value)
                    }
                ...
                <Field label="AI Tools Currently Used">
                  <TextArea
                    ...
                    onChange={(event) =>
                      updateNestedField("marketing", "aiToolsUsed", event.target.value)
                    }
                ...
                <Field label="Additional Marketing Notes">
                  <TextArea
                    ...
                    onChange={(event) =>
                      updateNestedField("marketing", "additionalMarketingNotes", event.target.value)
                    }
                  />
                </Field>
              </div>
