...
const initialRows: OverdueInvoicesRow[] = [
  {
    id: "OverdueInvoices-1",
    name: "PO-001",
...
function OverdueInvoicePage() {
  ...
  const columns = useMemo<ColumnDef<OverdueInvoicesRow>[]>(
    () => [
      {
        id: "select",
        header: () => (
  ...
  function addPurchaseOrder() {
    setRows((current) => [
      {
        id: `OverdueInvoices-${current.length + 1}`,
